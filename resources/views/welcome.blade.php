...
<div class="row">
    <div class="col-12">
    <footer class="c-footer col-12 mb-2">
    <div class="footer-content">
        <span><h5 class="text-white">Today's Statistics {{ \Carbon\Carbon::now()->format('d/m/y') }}</h5> </span>

        <span class="version-info"> <strong class="text-white"><h3 class="text-c-red">Welcome {{ auth()->user()->name }}</h3></strong></span>
    </div>
        </div>
...
<footer class="c-footer col-md-12">
    <div class="footer-content">
        <span>Pos © {{ date('Y') }} || Developed by <strong><a target="_blank" href="https://wa.me/+923339739504" class="footer-link">ISI SOFTWARE SOLUTION</a></strong></span>
        <span class="version-info">Version <strong class="text-danger">1.0</strong></span>
    </div>
</footer>
@endsection