        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="total">Total <small class="text-info">[PKR]</small></label>
                        <input type="number" class="form-control" id="total" x-ref="total" name="total"
                            placeholder="Total Purchase Cost">
                    </div>
                    <div class="form-group">
                        <label for="paid">Paid <small class="text-info">[PKR]</small></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Due<small class="text-info">[PKR]</small></label>
