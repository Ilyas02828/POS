            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="total">Total Due<small class="text-info">[PKR]</small></label>
                        <input type="number" class="form-control" id="total" name="total" x-model="total_due" readonly>
                    </div>
                    <div class="form-group">
                        <label for="paid">Pay Now <small class="text-info">[PKR]</small></label>
                        <input type="number" class="form-control" id="paid" x-model="paid"
                            x-on:input="due = total_due - paid" x-on:blur="setStatus()">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Remaining Due<small class="text-info">[PKR]</small></label>
                    ...
                    <div class="form-group">
                        <label for="status">Payment Status<small class="text-info">[PKR]</small></label>
