        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Paid Amount <small class="text-info">[PKR]</small></label>
                        <input type="number" class="form-control" id="name" placeholder="Paid Amount"
                            x-bind:disabled="paid" x-model.number="paid_amount">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Due Amount <small class="text-info">[PKR]</small></label>
