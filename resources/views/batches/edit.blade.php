        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="paid_amount">Payable Amount <small class="text-info">[PKR]</small></label>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Per Unit Purchase Price <small
                                class="text-info">[PKR]</small></label>
                    ...
                    <div class="form-group">
                        <label for="name">Total Purchase Cost <small class="text-info">[PKR]</small></label>
                    ...
                    <div class="form-group">
                        <label for="paid_amount">Paid Amount <small class="text-info">[PKR]</small></label>
                        <input type="number" class="form-control" id="paid_amount" placeholder="Paid Amount"
                    ...
                    <div class="form-group">
                        <label for="due_amount">Due Amount <small class="text-info">[PKR]</small></label>
